...
* regressions1_drinksmore5cal.do
...
log using ../logs/regressions1_drinksmore5cal, text replace
...
use /data/gsb/SBC/working/setup_daily_drinksmore5cal
...
xi: areg dollarsperday law i.txdow $weather i.txweek, absorb(store)
estimates store reg_dollars 
xi: areg txsperday law i.txdow $weather i.txweek, absorb(store)
estimates store reg_txs 
xi: areg itemsperday law i.txdow $weather i.txweek, absorb(store)
estimates store reg_items 
xi: areg dollarsperitem law i.txdow $weather i.txweek, absorb(store)
estimates store reg_dollarsitem 
xi: areg calsper1P law i.txdow $weather i.txweek, absorb(store)
estimates store reg_cals1P 
xi: areg itemsper1P law i.txdow $weather i.txweek, absorb(store)
estimates store reg_items1P 
xi: areg dollarsper1P law i.txdow $weather i.txweek, absorb(store)
estimates store reg_dollars1P 

estimates table reg_dollars reg_txs reg_items reg_dollarsitem reg_cals1P reg_items1P reg_dollars1P, b(%9.3f) star(.05 .01 .001) stats(N r2)
...
line hi wk, ///
  ...
  legend(off) ///
  ysize(6) xsize(7) ///
  saving($graphdir/revenue_meancoefs_drinksmore5cal, replace)

graph export $graphdir/revenue_meancoefs_drinksmore5cal.eps, logo(off) replace
!epstopdf $graphdir/revenue_meancoefs_drinksmore5cal.eps
...
line hi wk, ///
  ...
  legend(off) ///
  ysize(6) xsize(7) ///
  saving($graphdir/txs_meancoefs_drinksmore5cal, replace)

graph export $graphdir/txs_meancoefs_drinksmore5cal.eps, logo(off) replace
!epstopdf $graphdir/txs_meancoefs_drinksmore5cal.eps
...
line hi wk, ///
  ...
  legend(off) ///
  ysize(6) xsize(7) ///
  saving($graphdir/cals1P_meancoefs_drinksmore5cal, replace)

graph export $graphdir/cals1P_meancoefs_drinksmore5cal.eps, logo(off) replace
!epstopdf $graphdir/cals1P_meancoefs_drinksmore5cal.eps
...
line hi wk, ///
  ...
  legend(off) ///
  ysize(6) xsize(7) ///
  saving($graphdir/items1P_meancoefs_drinksmore5cal, replace)

graph export $graphdir/items1P_meancoefs_drinksmore5cal.eps, logo(off) replace
!epstopdf $graphdir/items1P_meancoefs_drinksmore5cal.eps
...
line hi wk, ///
  ...
  legend(off) ///
  ysize(6) xsize(7) ///
  saving($graphdir/dollars1P_meancoefs_drinksmore5cal, replace)

graph export $graphdir/dollars1P_meancoefs_drinksmore5cal.eps, logo(off) replace
!epstopdf $graphdir/dollars1P_meancoefs_drinksmore5cal.eps
