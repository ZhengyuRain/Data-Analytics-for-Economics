...
* regressions1_nyc_p90.do

log using ../logs/regressions1_nyc_p90_logs, text replace

clear
set more off
set mem 15g

use $bigdatadir/working/nyc/setup_daily_p90
ge ny=1
append using $bigdatadir/working/bos/setup_daily_p90
append using $bigdatadir/working/phi/setup_daily_p90
replace ny=0 if ny==.
