...
log using ../logs/regressions1_weekendmethod, text replace
...
* Generate revenues by day of week
ge weekend = (txdow==0 | txdow==6)
sort store weekend 
by store weekend: egen meandollarsweekweekend=mean(dollarsperday)
by store: egen weekdayspreadvar=sd(meandollarsweekweekend)
egen medianweekdayspreadvar=median(weekdayspreadvar)
* Keep biggest weekday-weekend spreads:
keep if weekdayspreadvar>medianweekdayspreadvar
...
line hi wk, ///
  ...
  legend(off) ///
  ysize(6) xsize(7) ///
  saving($graphdir/revenue_meancoefs_weekendmethod, replace)

graph export $graphdir/revenue_meancoefs_weekendmethod.eps, logo(off) replace
!epstopdf $graphdir/revenue_meancoefs_weekendmethod.eps
...
line hi wk, ///
  ...
  legend(off) ///
  ysize(6) xsize(7) ///
  saving($graphdir/txs_meancoefs_weekendmethod, replace)

graph export $graphdir/txs_meancoefs_weekendmethod.eps, logo(off) replace
!epstopdf $graphdir/txs_meancoefs_weekendmethod.eps
...
line hi wk, ///
  ...
  legend(off) ///
  ysize(6) xsize(7) ///
  saving($graphdir/cals1P_meancoefs_weekendmethod, replace)

graph export $graphdir/cals1P_meancoefs_weekendmethod.eps, logo(off) replace
!epstopdf $graphdir/cals1P_meancoefs_weekendmethod.eps
...
line hi wk, ///
  ...
  legend(off) ///
  ysize(6) xsize(7) ///
  saving($graphdir/items1P_meancoefs_weekendmethod, replace)

graph export $graphdir/items1P_meancoefs_weekendmethod.eps, logo(off) replace
!epstopdf $graphdir/items1P_meancoefs_weekendmethod.eps
...
line hi wk, ///
  ...
  legend(off) ///
  ysize(6) xsize(7) ///
  saving($graphdir/dollars1P_meancoefs_weekendmethod, replace)

graph export $graphdir/dollars1P_meancoefs_weekendmethod.eps, logo(off) replace
!epstopdf $graphdir/dollars1P_meancoefs_weekendmethod.eps
