...
insheet using ../data/nutrition/nutrition_food_byzones_5_15_16_51_64.txt
...
save ../data/working/foodnutr_zoneinfo, replace
keep name cal foodzone
save ../data/working/foodcal_zoneinfo, replace
