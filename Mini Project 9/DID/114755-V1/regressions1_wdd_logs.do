...
log using $logdir/regressions1_wdd_logs, text replace
...
ge nyafterapril = txmonth>=5 | txyear>=2009
ge nyafterjune = txmonth>=7 | txyear>=2009
...
ge law_rest=law*rest_perperson
ge law_chainrest=law*chainrest_perperson
ge law_inc=law*medhhinc 
...
*global lawvars "law law_dd100m nyafterapril nyafterapril_dd100m nyafterjune nyafterjune_dd100m"
global lawvars "law law_dd100m"
...
xi: areg log_dollarsperday_drinks $lawvars i.txdow i.txweek $weather, absorb(store)
estimates store reg_dollars_drinks 
xi: areg log_dollarsperday_snacks $lawvars i.txdow i.txweek $weather, absorb(store)
