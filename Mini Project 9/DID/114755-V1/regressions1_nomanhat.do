...
log using ../logs/regressions1_nomanhat, text replace
...
* Keep only Queens, Bronx, Brooklyn in NY, Philly and Boston as controls

keep if county=="Queens" | county=="Kings" | county=="Bronx" | zone==15 | zone==51
...
line hi wk, ///
  ...
  legend(off) ///
  ysize(6) xsize(7) ///
  saving($graphdir/revenue_meancoefs_nomanhat, replace)

graph export $graphdir/revenue_meancoefs_nomanhat.eps, logo(off) replace
!epstopdf $graphdir/revenue_meancoefs_nomanhat.eps
...
line hi wk, ///
  ...
  legend(off) ///
  ysize(6) xsize(7) ///
  saving($graphdir/txs_meancoefs_nomanhat, replace)

graph export $graphdir/txs_meancoefs_nomanhat.eps, logo(off) replace
!epstopdf $graphdir/txs_meancoefs_nomanhat.eps
...
line hi wk, ///
  ...
  legend(off) ///
  ysize(6) xsize(7) ///
  saving($graphdir/cals1P_meancoefs_nomanhat, replace)

graph export $graphdir/cals1P_meancoefs_nomanhat.eps, logo(off) replace
!epstopdf $graphdir/cals1P_meancoefs_nomanhat.eps
...
line hi wk, ///
  ...
  legend(off) ///
  ysize(6) xsize(7) ///
  saving($graphdir/items1P_meancoefs_nomanhat, replace)

graph export $graphdir/items1P_meancoefs_nomanhat.eps, logo(off) replace
!epstopdf $graphdir/items1P_meancoefs_nomanhat.eps
...
line hi wk, ///
  ...
  legend(off) ///
  ysize(6) xsize(7) ///
  saving($graphdir/dollars1P_meancoefs_nomanhat, replace)

graph export $graphdir/dollars1P_meancoefs_nomanhat.eps, logo(off) replace
!epstopdf $graphdir/dollars1P_meancoefs_nomanhat.eps
