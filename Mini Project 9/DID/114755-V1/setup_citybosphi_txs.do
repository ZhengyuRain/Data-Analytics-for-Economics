...
*setup_citybosphi_txs.do

log using $logdir/setup_citybosphi_txs, text replace


clear
use $bigdatadir/working/bos/setup_daily_txs
...
* ALWAYS USE PRE PREIOD
drop if after_nyc==1

* GROUP BOS AND PHI
replace zone=0 if zone~=16
...
save $bigdatadir/working/setup_citybosphi_txs, replace
