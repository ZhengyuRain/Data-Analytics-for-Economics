...
* regressions1_nyc_robust1.do

* CHANGED TO DO LOGS!!!

* ROBUSTNESS CHECK: ADD NY*DOW INTERACTIONS AND DROP HOLIDAYS

log using $logdir/regressions1_nyc_robust1, text replace
...
xi: areg dollarsperday $lawvars i.txdow*i.zone i.txweek $weather, absorb(store) vce(robust)
estimates store reg_dollars 
xi: areg txsperday $lawvars i.txdow*i.zone i.txweek $weather, absorb(store) vce(robust)
...
xi: areg dollarspertx $lawvars i.txdow*i.zone i.txweek $weather, absorb(store) vce(robust)
estimates store reg_dollars_pertx
xi: areg dollarsperitem $lawvars i.txdow*i.zone i.txweek $weather, absorb(store) vce(robust)
estimates store reg_dollars_peritem



xi: areg calsper1T $lawvars i.txdow*i.zone i.txweek $weather, absorb(store) vce(robust)
estimates store reg_cals1T 
xi: areg calsper1Tdrinks $lawvars i.txdow*i.zone i.txweek $weather, absorb(store) vce(robust)
estimates store reg_cals1Tdrinks 
xi: areg calsper1Tsnacks $lawvars i.txdow*i.zone i.txweek $weather, absorb(store) vce(robust)
estimates store reg_cals1Tsnacks 
xi: areg itemsper1T $lawvars i.txdow*i.zone i.txweek $weather, absorb(store) vce(robust)
estimates store reg_items1T 
xi: areg itemsper1Tdrinks $lawvars i.txdow*i.zone i.txweek $weather, absorb(store) vce(robust)
estimates store reg_items1Tdrinks 
xi: areg itemsper1Tsnacks $lawvars i.txdow*i.zone i.txweek $weather, absorb(store) vce(robust)
