...
log using $logdir/regressions1_wddexplvar, text replace
...
************* DD AND DEMOG INTERACTION ***************

global lawvars "law law_dd100m law_chainrest law_inc law_educ law_age law_male"
* Regressions:
