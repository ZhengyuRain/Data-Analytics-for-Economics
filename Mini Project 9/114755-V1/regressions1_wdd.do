...
log using $logdir/regressions1_wdd, text replace
...
replace dollarsperday_drinks= log(dollarsperday_drinks)
replace dollarsperday_snacks= log(dollarsperday_snacks)
