...
* regressions1_justbeforeandafter.do
...
log using ../logs/regressions1_justbeforeandafter, text replace
...
* Keep only 4 weeks before and after

keep if txweek>=10 & txweek<=18
...
line hi wk, ///
  ...
  legend(off) ///
  ysize(6) xsize(7) ///
  saving($graphdir/revenue_meancoefs_justbeforeandafter, replace)

graph export $graphdir/revenue_meancoefs_justbeforeandafter.eps, logo(off) replace
!epstopdf $graphdir/revenue_meancoefs_justbeforeandafter.eps
...
line hi wk, ///
  ...
  legend(off) ///
  ysize(6) xsize(7) ///
  saving($graphdir/txs_meancoefs_justbeforeandafter, replace)

graph export $graphdir/txs_meancoefs_justbeforeandafter.eps, logo(off) replace
!epstopdf $graphdir/txs_meancoefs_justbeforeandafter.eps
...
line hi wk, ///
  ...
  legend(off) ///
  ysize(6) xsize(7) ///
  saving($graphdir/cals1P_meancoefs_justbeforeandafter, replace)

graph export $graphdir/cals1P_meancoefs_justbeforeandafter.eps, logo(off) replace
!epstopdf $graphdir/cals1P_meancoefs_justbeforeandafter.eps
...
line hi wk, ///
  ...
  legend(off) ///
  ysize(6) xsize(7) ///
  saving($graphdir/items1P_meancoefs_justbeforeandafter, replace)

graph export $graphdir/items1P_meancoefs_justbeforeandafter.eps, logo(off) replace
!epstopdf $graphdir/items1P_meancoefs_justbeforeandafter.eps
...
line hi wk, ///
  ...
  legend(off) ///
  ysize(6) xsize(7) ///
  saving($graphdir/dollars1P_meancoefs_justbeforeandafter, replace)

graph export $graphdir/dollars1P_meancoefs_justbeforeandafter.eps, logo(off) replace
!epstopdf $graphdir/dollars1P_meancoefs_justbeforeandafter.eps
