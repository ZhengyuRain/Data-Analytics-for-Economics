...
log using ../logs/regressions1_extras, text replace
...
use /data/gsb/SBC/working/setup_daily_extras
...
line hi wk, ///
  ...
  legend(off) ///
  ysize(6) xsize(7) ///
  saving($graphdir/revenue_meancoefs_extras, replace)

graph export $graphdir/revenue_meancoefs_extras.eps, logo(off) replace
!epstopdf $graphdir/revenue_meancoefs_extras.eps
...
line hi wk, ///
  ...
  legend(off) ///
  ysize(6) xsize(7) ///
  saving($graphdir/txs_meancoefs_extras, replace)

graph export $graphdir/txs_meancoefs_extras.eps, logo(off) replace
!epstopdf $graphdir/txs_meancoefs_extras.eps
...
line hi wk, ///
  ...
  legend(off) ///
  ysize(6) xsize(7) ///
  saving($graphdir/cals1P_meancoefs_extras, replace)

graph export $graphdir/cals1P_meancoefs_extras.eps, logo(off) replace
!epstopdf $graphdir/cals1P_meancoefs_extras.eps
...
line hi wk, ///
  ...
  legend(off) ///
  ysize(6) xsize(7) ///
  saving($graphdir/items1P_meancoefs_extras, replace)

graph export $graphdir/items1P_meancoefs_extras.eps, logo(off) replace
!epstopdf $graphdir/items1P_meancoefs_extras.eps
...
line hi wk, ///
  ...
  legend(off) ///
  ysize(6) xsize(7) ///
  saving($graphdir/dollars1P_meancoefs_extras, replace)

graph export $graphdir/dollars1P_meancoefs_extras.eps, logo(off) replace
!epstopdf $graphdir/dollars1P_meancoefs_extras.eps
