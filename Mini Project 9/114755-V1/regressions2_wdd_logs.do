...
preserve
xi: areg log_dollarsperday  i.nydd100m*i.txweek i.ny*i.txweek  $weather i.txdow , absorb(store)
mat b = get(_b)
mat b = b'
mat V = get(VCE)
mat dv = vecdiag(V)
...
preserve
xi: areg log_txsperday i.nydd100m*i.txweek i.ny*i.txweek  $weather i.txdow , absorb(store)
mat b = get(_b)
mat b = b'
mat V = get(VCE)
mat dv = vecdiag(V)
...
preserve
xi: areg log_calsper1T i.nydd100m*i.txweek i.ny*i.txweek  $weather i.txdow , absorb(store)
mat b = get(_b)
mat b = b'
mat V = get(VCE)
mat dv = vecdiag(V)
...
preserve
xi: areg log_calsper1Tdrinks i.nydd100m*i.txweek i.ny*i.txweek  $weather i.txdow , absorb(store)
mat b = get(_b)
mat b = b'
mat V = get(VCE)
mat dv = vecdiag(V)
...
preserve
xi: areg log_calsper1Tsnacks i.nydd100m*i.txweek i.ny*i.txweek  $weather i.txdow , absorb(store)
mat b = get(_b)
mat b = b'
mat V = get(VCE)
mat dv = vecdiag(V)
